package io.feiyue.search.service;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import io.feiyue.item.pojo.*;
import io.feiyue.search.client.BrandClient;
import io.feiyue.search.client.CategoryClient;
import io.feiyue.search.client.GoodsClient;
import io.feiyue.search.client.SpecificationClient;
...
public class SearchService {
    ...
    public Goods buildGoods(Spu spu) throws IOException {
        ...
        skus.forEach(sku -> {
            ...
            // 获取sku中的图片,数据库的土拍你可能是多张,多张是以","分隔,所以页以逗号来切割返回图片数据,获取第一张图片
